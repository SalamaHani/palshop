...
export default function ShopifySearchInput() {
    ...
    return (
        ...
        >
            ...
            <div
                className={`transition-all duration-500 ease-in-out overflow-y-auto scrollbar-professional ${showSuggestions ? 'max-h-[25vh] opacity-100 mt-4' : 'max-h-0 opacity-0 mt-0'}`}
            >
